...
pen.hideturtle()
pen.goto(0, 260)
pen.write("Me: 0 vs. Everybody: 0", align="center", font=("Courier", 18,"normal"))
...
while True:
    ...
    if ball.xcor() > 390:
        ...
        score_a += 1
        pen.clear()
        pen.write("Me: {} vs. Everybody: {}".format(score_a, score_b), align="center", font=("Courier", 18,"normal"))
